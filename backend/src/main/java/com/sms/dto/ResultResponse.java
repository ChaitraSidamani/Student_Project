...
public class ResultResponse {
    ...
    private boolean exportedToAdmin;
    ...
    public static ResultResponse from(Result res) {
        ...
        r.setPublished(Boolean.TRUE.equals(res.getPublished()));
        r.setExportedToAdmin(Boolean.TRUE.equals(res.getExportedToAdmin()));
    ...
    public boolean isExportedToAdmin() { return exportedToAdmin; }
